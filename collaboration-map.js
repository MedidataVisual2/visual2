    ...
    function C(Z) {
        ...
        // **Removing this bit above makes the visual crash, ! **
            ...
            aa.append("text").attr("fill", N).attr("text-anchor", "middle").attr("y", (o + t) * -1).text(function(ae) {
                // **Should remove the ITEM text in the circle in product page, however link still remains. Find where to remove link!
        ...
        E.selectAll("circle").attr("fill", function(X) {
            ...
            if (X === L.node) {
                ...
                if (X.type === "product") {
                    ...
                    if (X.type === "collaboration") {
                        return l(X, "steelblue", N, "steelblue")
                    }
                }
            }
            return null
            ...
            if (X === L.node) {
                ...
                if (X.type === "product" || X.type === "collaboration") {
                    return 1.5
                }
            }
            return null
